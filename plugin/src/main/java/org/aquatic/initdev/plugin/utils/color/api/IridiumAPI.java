package org.aquatic.initdev.plugin.utils.color.api;

import com.google.common.collect.ImmutableMap;
import net.md_5.bungee.api.ChatColor;
import org.apache.commons.lang.Validate;
import org.aquatic.initdev.plugin.utils.color.api.patterns.Gradient;
...
public final class IridiumAPI {
	...
	/**
	 * The current version of the server into a form of a major version.
		...
		for (int i = 0; i < characters.length; i++) {
			if (characters[i].equals("&") || characters[i].equals("§")) {
				if (i + 1 < characters.length) {
					if (characters[i + 1].equals("r")) specialColors.setLength(0);
					else {
